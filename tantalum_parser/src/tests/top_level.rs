use tantalum_ast::{
    Parameter, ParameterKind, Statement, StatementKind, TopLevelExpression, TopLevelExpressionKind, Type, TypeKind
};
                    ...
                    parameters: vec![
                        Parameter {
                            ...
                            kind: ParameterKind::Named {
                                name: "argc",
                                ty: Type {
                                    span: Span::new("function_declaration_with_parameters", 14, 17, 1, 15),
                        ...
                        Parameter {
                            ...
                            kind: ParameterKind::Named {
                                name: "argv",
                                ty: Type {
                                    span: Span::new("function_declaration_with_parameters", 25, 36, 1, 26),
                                    kind: TypeKind::UnsizedArray(Box::new(Type {
                                        span: Span::new("function_declaration_with_parameters", 26, 35, 1, 27),
                                        kind: TypeKind::Pointer(Box::new(Type {
                                            span: Span::new("function_declaration_with_parameters", 27, 35, 1, 28),
                                            kind: TypeKind::Const(Box::new(Type {
                                                span: Span::new("function_declaration_with_parameters", 33, 35, 1, 34),
...
fn external_function_declaration_with_variadic() {
    ...
    let mut parser = Parser::new(Lexer::new("external_function_declaration_with_variadic", source));
                    ...
                    parameters: vec![
                        Parameter {
                            ...
                            kind: ParameterKind::Named {
                                name: "format",
                                ty: Type {
                                    span: Span::new("external_function_declaration_with_variadic", 25, 34, 1, 26),
                                    kind: TypeKind::Pointer(Box::new(Type {
                                        span: Span::new("external_function_declaration_with_variadic", 26, 34, 1, 27),
                                        kind: TypeKind::Const(Box::new(Type {
                                            span: Span::new("external_function_declaration_with_variadic", 32, 34, 1, 33),
                                            kind: TypeKind::Named("u8")
                                        }))
                                    }))
                                }
